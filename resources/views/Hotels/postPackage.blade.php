              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="phone_email">
                  ...
                  <div class="form-text">
                    ...
                    <input type="text" name="singleRoom" placeholder="" required="">
                  </div> 
                </div> 
                <div class="phone_email phone_email1">
                  ...
                  <div class="form-text">
                    ...
                    <input type="text" name="twoPerRoom" placeholder=""  required="">
                  </div> 
                </div> 
                ...
                <div class="phone_email">
                  ...
                  <div class="form-text">
                    <i class="fa fa-user" aria-hidden="true"></i>
                    <input type="text" name="fourPerRoom" placeholder=""  required="">
                  </div> 
                </div>
                <div class="phone_email phone_email1">
                  <label>wifi : </label>
                  <div class="form-text">
                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                    <input type="text" name="wifi" placeholder="" required="">
                  </div>
                </div>
                 <div class="phone_email">
                  <label>Price : </label>
